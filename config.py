"""
Scoring tables and configuration settings for the Chen Auto CV Algorithm.
"""
DB_FILE = "debate_cv.db"

# Eligible tournament speaking classes (Threshold: Class S-C and above)
ELIGIBLE_CLASSES = {
    "S-WUDC", "S-AAA+", "S-AAA", "S-AA+", "S-AA", "S-A+", "S-A", "S-B", "S-C"
}

# Premier Regional Majors (+0.4 bonus)
PRM_KEYWORDS = ["wudc", "eudc", "australs", "uadc", "naudc", "abp", "paudc", "cmude", "wsdc"]

# Chen Base Speaking Points Table
...
STAGE_HIERARCHY = {"Win": 7, "GF": 6, "SF": 5, "QF": 4, "OF": 3, "DOF": 2, "QOF": 1}